...
const StyledButton = styled.button`
  ...
  ${p => p.appearance === APPEARANCES.PRIMARY && css`
  ...
  ${p => p.appearance === APPEARANCES.SECONDARY && css`
  ...
  ${p => p.appearance === APPEARANCES.PRIMARY_OUTLINE && css`
  ...
  ${p => p.appearance === APPEARANCES.SECONDARY_OUTLINE && css`
...
const applyStyle = ButtonWrapper => {
  ...
  ({
    ...
    isUnclickable,
    ...rest
  }) => /*#__PURE__*/_jsx(ButtonWrapper, { ...rest
  }));
};
...
export function Button({
  ...
  const buttonInner = /*#__PURE__*/_jsxs(Fragment, {
  ...
  const StyledButtonWrapper = React.useMemo(() => applyStyle(ButtonWrapper), [ButtonWrapper]); // eslint-disable-next-line @typescript-eslint/no-explicit-any
  ...
  return /*#__PURE__*/_jsx(SelectedButton, {
    isLoading: isLoading,
    disabled: isDisabled,
    ...props,
